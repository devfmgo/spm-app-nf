                ...
                <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                    ...
                    <div class=" flex  p-2">
                        <a href="{{route('data-document','all')}}"
                            class="font-normal mx-1 {{$request === 'all' ? 'text-indigo-500' :''}}">All
                        </a>
                        |
                        <a href="{{route('data-document','delete')}}" class="font-normal mx-1 {{$request === 'delete'
                            ? 'text-indigo-500' :''}}">File Delete
                            ({{$softDelete}})</a>
                    </div>
                </div>
                        ...
                        <td class="border-t-0 px-6 align-center border-l-0 border-r-0 text-sm whitespace-nowrap p-4">
                            ...
                            <div class="md:flex space-x-2">
                                ...
                                <a href="{{route('confirm-delete',$document->id)}}"
                                    class="text-gray-200 font-semibold bg-red-400 p-2 rounded-full"><svg
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                        <path stroke-linecap="round" stroke-linejoin="round"
