        ...
        <div class="rounded-t mb-0 px-4 py-3 border-0">
            <div class="flex flex-wrap items-center">
                <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                    <h3 class="font-bold text-blue-700 text-xl">Data Unit SIT Nurul Fikri</h3>
                </div>
        ...
        <div class="block w-full overflow-x-auto">
            <table class="items-center bg-transparent w-full border-collapse ">
                ...
                <tbody>
                    ...
                    <tr>
                        <th
                            class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left text-blueGray-700 w-20 ">
                            {{$loop->iteration}}
                        </th>
                        ...
                        {{-- <td
                            ...
                            <a href="{{route('edit',$unit->id)}}" class="text-gray-700 font-semibold">Edit</a>
                        </td> --}}
