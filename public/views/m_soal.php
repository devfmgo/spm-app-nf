        ...
        <table class="table table-bordered" id="datatabel">
          <thead>
            <tr>
              ...
              <td width="5%" style="text-align:center;">P<sub>eserta</sub></td>
              <td width="5%" style="text-align:center;">B<sub>enar</sub></td>
              <td width="5%" style="text-align:center;">S<sub>alah</sub></td>
              <td width="15%">Aksi</td>
            </tr>
          </thead>
